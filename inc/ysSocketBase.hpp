...
namespace YS::Network
{
    static const unsigned int MaxSocketBufferSize = 512;
    ...
    {
    public:
        ServerSocket(IPVersion ipVersion, ProtocolType protocol, int port, void(*handleClient)(SocketBase* clientSocket));
    ...
    private:
        static void ServerEntry(ServerSocket* caller, void(*handleClient)());
